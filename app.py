...
def home():
    ...
    if request.method == 'POST':
        ...
        if not name:
            return render_template("home.html", error="Please enter a room name!", code=code, name=name)
...
def room():
    ...
    return render_template("chat.html",room=room,messages=rooms[room]["messages"])
